...
<!DOCTYPE html>
 <html lang="en" class="no-js"> 
    ...
    <title>Digital Marketing & SEO Portfolio - Digitalinfoways</title>
    <meta name="description" content="Have a look at SEO Portfolio to view examples of past work.  Digitalinfoways Portfolio of SEO, PPC, ASO, eCommerce Development, Wb desgin.">
...
<section id="service-slider" class="bg-img-13" >
    ...
    font-weight: 700; "><span style="color: #f37e05">Port</span>folio</h2>
...
<!-- gallery -->
<section class="about-us banner_w3lspvt" style="padding-top: 50px;">

  <h2 class="text-center w3layouts w3 w3l w3ls" style="margin-bottom: 30px;"><span >Portfolio</h2>
    ...
    <div class="container">
        ...
        <div class="gallery_gds agileits-w3layouts">
            <ul class="simplefilter">
                ...
                <li data-filter="3">SMM</li>
                <li data-filter="4">Web Design / Deelopment</li>
                <li data-filter="5">Logo Design</li>
            ...
            <div class="filtr-container">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 filtr-item" data-category="1" data-sort="Luminous night">
                     <div class="zp">
                    <div class="hover ehover14">
                        <a href="" target="_blank" >
                            <img src="img/portfolio/port1/12.png" alt="" class="img-responsive"   style="height: 300px;">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 filtr-item" data-category="1" data-sort="City wonders">
                    ...
                    <div class="hover ehover14">
                        <a href="" target="_blank">
                            <img src="img/portfolio/port1/14.png" alt="" class="img-responsive"   style="height: 300px;">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 filtr-item" data-category="2" data-sort="Peaceful lake">
                    ...
                    <div class="hover ehover14">
                        <a href="" target="_blank">
                            <img src="img/portfolio/port1/23.png" alt="" class="img-responsive"   style="height: 300px;">
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-4 filtr-item" data-category="2" data-sort="Peaceful lake">
                    ...
                    <div class="hover ehover14">
                        <a href="" target="_blank">
                            <img src="img/portfolio/port1/24.png" alt="" class="img-responsive"   style="height: 300px;">
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-4 filtr-item" data-category="2" data-sort="Peaceful lake">
                    ...
                    <div class="hover ehover14">
                        <a href="" target="_blank">
                            <img src="img/portfolio/port1/26.png" alt="" class="img-responsive"   style="height: 300px;">
                 ...
                 <div class="col-lg-4 col-md-4 col-sm-4 filtr-item" data-category="3" data-sort="Peaceful lake">
                    ...
                    <div class="hover ehover14">
                        <a href="" target="_blank">
                            <img src="img/portfolio/digital/1.jpg" alt="" class="img-responsive"   style="height: 300px;">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 filtr-item" data-category="3" data-sort="Peaceful lake">
                    ...
                    <div class="hover ehover14">
                        <a href="" target="_blank">
                            <img src="img/portfolio/digital/2.png" alt="" class="img-responsive"   style="height: 300px;">
                 ...
                 <div class="col-lg-4 col-md-4 col-sm-4 filtr-item" data-category="3" data-sort="Peaceful lake">
                    ...
                    <div class="hover ehover14">
                        <a href="" target="_blank">
                            <img src="img/portfolio/digital/3.png" alt="" class="img-responsive"   style="height: 300px;">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 filtr-item" data-category="4" data-sort="Peaceful lake">
                    ...
                    <div class="hover ehover14">
                        <a href="" target="_blank">
                            <img src="img/portfolio/port1/11.png" alt="" class="img-responsive"  style="height: 300px;">
                 ...
                 <div class="col-lg-4 col-md-4 col-sm-4 filtr-item" data-category="4" data-sort="Peaceful lake">
                    ...
                    <div class="hover ehover14">
                        <a href="" target="_blank">
                            <img src="img/portfolio/port1/19.png" alt="" class="img-responsive"   style="height: 300px;">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 filtr-item" data-category="4" data-sort="Peaceful lake">
                    ...
                    <div class="hover ehover14">
                        <a href="" target="_blank">
                            <img src="img/portfolio/digital/6.jpg" alt="" class="img-responsive"   style="height: 300px;">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 filtr-item" data-category="5" data-sort="Peaceful lake">
                    ...
                    <div class="hover ehover14">
                        <a href="" target="_blank">
                            <img src="img/portfolio/ios/2.png" alt="" class="img-responsive"   style="height: 300px;">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 filtr-item" data-category="5" data-sort="Peaceful lake">
                    ...
                    <div class="hover ehover14">
                        <a href="" target="_blank">
                            <img src="img/portfolio/ios/3.png" alt="" class="img-responsive"   style="height: 300px;">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 filtr-item" data-category="5" data-sort="Peaceful lake">
                    ...
                    <div class="hover ehover14">
                        <a href="" target="_blank">
                            <img src="img/portfolio/ios/4.png" alt="" class="img-responsive"   style="height: 300px;">
...
<!--
 <section class="digital-marketing-info" style="padding-top: 50px;">
  <div class="container">
     <div class="row">
      <div class="col-md-8 col-xs-12">
        <div class="aboutins" style="    padding: 0px 0px;">
        <div class="info-data">
          <h2 style="color: #f37e05;
     font-size: 40px;
    text-decoration: underline;
    font-weight: 700;
    text-align: left;"><span style="color: #f37e05">Portfolio </span></h2>
          <p style="font-size: 29px;;
    color: black;
        font-family: inherit;line-height: 37px;">We bridge intricate business requirements with proficient technical solutions to build affluent product for you.
</p>
      ...
      <div class="col-md-4 col-xs-12 ">
        ...
        <div class="info-image " style="padding-left:80px;">
          <img src="img/portfolio/brush.png" class="img-responsive" style="width: 200px; ">
        </div>
 ...
 <!--end-->
<!--
<div class="about-bottom" style="padding-bottom: 50px;">
  <div class="container-fluid">
  <div class="row">
    <div class="col-md-6  wow bounceInLeft animated portbl" >
      <div class="top-right">
        <img src="img/portfolio/port-page/incident-mgmt-mobile.png" class="wow bounceIn" style="width:100%;height: 600px;">
      </div>
   </div>
    <div class="col-md-6 w3l_about_bottom_right wow bounceInRight animated" >
...
<a  href="https://digitalinfoways.com/case-study.php"class="buts " style=" border: 2px solid #5e4ee6;border-radius: 7px; width: 200px;height: 50px; margin-top:30px; ">Discover more</a>
  ...
  <div class="about-bottom" style="padding-bottom: 50px;">
   ...
   <div class="row">
      <div class="col-md-6 w3l_about_bottom_right wow bounceInRight animated" >
      <div class="portpp">
      <h3 class="agileinfo_header1 ports1" > Mobile Healthcare App</h3>
...
<a  href="https://digitalinfoways.com/case-study.php"class="buts " style=" border: 2px solid #5e4ee6;border-radius: 7px; width: 200px;height: 50px; margin-top:30px; ">Discover more</a>
    ...
    <div class="col-md-6 portbl1 wow bounceInLeft animated" >
       <div class="top-left">
        <img src="img/portfolio/port-page/mHealth-mobile.png" class="wow bounceIn" style="width:100%;height: 600px;">
      </div>
...
<div class="about-bottom">
  <div class="container-fluid">
  <div class="row">
    <div class="col-md-6 portbl2 wow bounceInLeft animated" >
      <div class="top-right">
        <img src="img/portfolio/port-page/blockchain-mobile.png" class="wow bounceIn" style="width:100%;height: 600px;">
      </div>
      
      
    </div>
    <div class="col-md-6 w3l_about_bottom_right wow bounceInRight animated" style="visibility: visible; animation-name: bounceInRight;">
      <div class="portp">
      <h3 class="agileinfo_header1 ports1" >Blockchain Game Development</h3>
      <p style="width:330px;  width: 288px;margin-bottom: 25px;"> 
...
<a  href="https://digitalinfoways.com/case-study.php"class="buts " style=" border: 2px solid #5e4ee6;border-radius: 7px; width: 200px;height: 50px; margin-top:30px; ">Discover more</a>
  ...
  <div class="about-bottom" style="padding-bottom: 50px;">
   ...
   <div class="row">
      <div class="col-md-6 w3l_about_bottom_right  wow bounceInRight animated" >
      <div class="portpp">
      <h3 class="agileinfo_header1 ports1" > Indoor Positioning App</h3>
      <p style="    width: 288px;  width: 288px;margin-bottom: 25px;"> 
...
<a  href="https://digitalinfoways.com/case-study.php"class="buts " style=" border: 2px solid #5e4ee6;border-radius: 7px; width: 200px;height: 50px; margin-top:30px; ">Discover more</a>  </div>
    ...
    <div class="col-md-6 portbl3 wow bounceInLeft animated" >
      <div class="top-left">
        <img src="img/portfolio/port-page/oym-mobile.png" class="wow bounceIn" style="width:100%;height: 600px;">
      </div>
...
<div class="about-bottom" style="padding-bottom: 50px;">
  <div class="container-fluid">
  <div class="row">
    <div class="col-md-6 portbl4  wow bounceInLeft animated" >
      <div class="top-right">
        <img src="img/portfolio/port-page/cryptocurrency-trading-mobile.png" class="wow bounceIn" style="width:100%;height: 600px;">
      </div>
    ...
    <div class="col-md-6 w3l_about_bottom_right wow bounceInRight animated" >
      <div class="portp">
      <h3 class="agileinfo_header1 ports1" >Crypto Currency Trading Social Platform</h3>
      <p style="width:330px;  width: 288px;margin-bottom: 25px;"> 
...
<div class="about-bottom" style="padding-bottom: 50px;">
  <div class="container-fluid">
   <div class="row">
      <div class="col-md-6 w3l_about_bottom_right wow bounceInRight animated" >
      <div class="portpp">
      <h3 class="agileinfo_header1 ports1" >Community Care - Communication App</h3>
      <p style="    width: 288px;margin-bottom: 25px;"> 
...
<a  href="https://digitalinfoways.com/case-study.php"class="buts " style=" border: 2px solid #5e4ee6;border-radius: 7px; width: 200px;height: 50px; margin-top:30px; ">Discover more</a>  
    ...
    <div class="col-md-6 portbl5 wow bounceInLeft animated" >
      <div class="top-left">
        <img src="img/portfolio/port-page/phr-mobile.png" class="wow bounceIn" style="width:100%;height: 600px;">
      </div>
