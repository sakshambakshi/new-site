...
<!--[if gt IE 8]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    <head>
        ...
        <meta property="og:url" content="https://www.digitalinfoways.com/social-pricing-plan.php" />
 <link rel="canonical" href="https://www.Digitalinfoways.com/social-pricing-plan.php" />
...
<script type='text/javascript' src='assets/js/menu.js' defer onload=''></script>
     ...
     <!--   End Fixed Navigation
        ...
        Home Slider
        ==================================== -->
<section id="service-slider" class="bg-img-11" >
    ...
    font-weight: 700; "><span style="color: #f37e05">Social Pricing</span> Plan</h2>
...
<section  class="testimonials banner_w3lspvt position-relative">
                <div class="sha">
    <p>SOCIAL PRICING PLAN</p>
  <h3 class="text-center agileits agileinfo wthree w3-agileits" >Social Pricing Plan</h3>
  <p class="text-center agileits agileinfo wthree w3-agileits" style="color: black;">Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum is simply dummy text of the printing<br> and typesetting industry.Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                ...
                <div class="container">
                    <div class="row" style="margin-top: 50px;">
                        <div class="col-md-3 wow animated fadeInUp animated" >
    ...
    font-weight: 700;
    font-size: 38px;
    line-height: 41px;">Monthly Budget Upto $4000</span>
    ...
    padding-top: 10px;">Express</h4>
                                ...
                                <ul>
                                    ...
                                    <li style=" background-color: #cac6c6;
    color: #444040;">Sign Up</li>
                        ...
                        <div class="col-md-3 wow animated fadeInUp animated" data-wow-delay="0.8s">
                            <div class="price-table text-center">
                                ...
                                <div class="value" style=" background-color: #ea720a;border-top-left-radius: 25px; border-top-right-radius: 25px;">
                                    <img src="img/pric3.png" style="    padding: 18px;
    border-radius: 69px;
    margin-top: -120px;
    background: #b3590a;width: 88px;">
                                    <span style="    color: #fbfbfb;
    font-weight: 700;
    font-size: 38px;
...
<section class="about-us banner_w3lspvt position-relative">
    ...
    font-weight: 600;
    color: #080850;
    margin-bottom: 20px;">Why Social Advertising?</h3>
                     <p style="text-align: justify; ">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse porta erat sit. Suspendisse porta erat sit amet eros sagittis, quis hendrerit libero aliquam. Fusce semper augue
                        ac dolor
                        efficitur.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse porta erat sit. Suspendisse porta erat sit amet eros sagittis, quis hendrerit libero aliquam. Fusce semper augue
            ac dolor
    ...
    font-weight: 600;
    color: #080850;
    margin-bottom: 20px;">Determination Of Social Pricing</h3>
                     <p style="text-align: justify; ">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse porta erat sit. Suspendisse porta erat sit amet eros sagittis, quis hendrerit libero aliquam. Fusce semper augue
                        ac dolor
                        efficitur.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse porta erat sit. Suspendisse porta erat sit amet eros sagittis, quis hendrerit libero aliquam. Fusce semper augue
            ac dolor
