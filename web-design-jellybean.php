...
<section id="" style="background: black;">
    ...
    font-weight: 700;margin-bottom: 20px; ">Web Design Jellybean Study Us</h2>
    <h2 style="text-align: center;
    color: white;
    font-size: 24px;
...
<section class="about-us banner_w3lspvt position-relative" >
    ...
    font-weight: 600;margin-bottom: 20px;margin-left: 25px;" >About Client</h3>
      <p style="text-align: justify; color: #676464;margin-left: 25px;">We had come upon a project on an exhibition stand design that provides designing, making, building, and managing the exhibition stands for trade show events. This type of website definitely requires very much describing and clearly showcases for their required client which will indirectly influence them to take a moment to think about this. Our client just wanted to make his website dynamic model and user-friendly that will make maximum possibilities to get the orders.    </div>
...
<div class="home-industry-sec">
  ...
  <section class="about-us banner_w3lspvt position-relative" style="margin-top:  -65px;">
    ...
    color: #676464;margin-bottom: 20px;">
                       ...
                       <li>  Made a very good reliable website pattern according to the business type using WordPress.</li>
<li> Used the PHP technology to create a dynamic webpage that can interact with the database.</li>
<li> Worked for making the website iPhone/mobile compatible.</li>
    ...
    padding: 2px 40px;
    color: #676464;">
                        <li> Used jquery to make much easier to use JavaScript on the website.</li>
<li> Used SEO plugin for the availability of comprehensive SEO tools that helps the website to rank easily in the search engine.</li>
<li> A highly agile system that can be set up easily and works out-of-the-box.</li>

<li> Track the activity of the team of technicians with Google maps.</li>
...
<div class="client-quote-section">
    ...
    font-size: 17px;
    line-height: 33px;
    padding: 25px 42px;">With the help of our website designing service, the client got very much satisfied personally and was able to showcase their work and achievements in an extremely generous manner which definitely helps to influence the more targeted audience towards the business.</p>
