...
<section class="about-us banner_w3lspvt position-relative" style="margin-top:  440px;">
    ...
    font-weight: 600;margin-bottom: 20px;margin-left: 25px;" >Client Profile and challenges:</h3>
    <h4 style="    text-align: justify;
    font-size: 24px;"></h4>
					<p style="text-align: justify; color: #676464;margin-left: 25px;">Instant carwash provides the waterless car washing services at the doorstep. From the internal services to the external service, eco-friendly products are used that make the customers satisfied. 

SEO strategies were not proactive. Although they are providing customer-oriented service they are unable to get the quality leads. They are facing issues in the branding and marketing of their services. 

</p>
                  </div>
                  <div class="img-block-head " style="padding-top: 40px;">
                    <h3  style="font-size: 32px; text-align: left;
    font-weight: 600;margin-bottom: 20px;margin-left: 25px;" >Our Approach</h3>
    <h4 style=" text-align: justify;
    ...
    <li>  • The competitive analysis approach was missing.  </li>
    <li>  • Link Building strategies were not used.  </li>
    <li>  • Blogs posts were not written with proper research.  </li>
    ...
    font-weight: 500;margin-bottom: 20px;margin-left: 25px;">Seo Plans And compaign:</h3>
                   <ul style="text-align: justify;
    font-size: 16px;
    padding: 2px 40px;
    color: #676464;">
   <li>   • Better blogs were written with proper keyword strategies.  </li>
   <li>   • We focused on building a strategic link to the important pages.   </li>
   <li>   • We helped in the ego bait that is specifying a particular product or service on the page.  </li>
   <li>   • We helped them expand the reach by organic search, exposure, and understanding of the target audience.  </li>
   <li>   • Page titles were changed to make it more relevant.  </li>
                  ...
                  <div class="img-block-head " style="padding-top: 40px;">
                    <h3  style="font-size: 25px; text-align: left;
    font-weight: 500;margin-bottom: 20px;margin-left: 25px;" >Business Impact:</h3>
    <ul style="text-align: justify;
    font-size: 16px;
    padding: 2px 40px;
          color: #676464;">
   <li>                    •  The incredible content helped in better ranking in the Google search.  </li>
   <li>   • High-quality links helped to compete in the organic search and there was an increase in the traffic on the website.  </li>
   <li>   • There was an increase in the lead generation and conversions rate.  </li>
   <li>   • There was an improvement in marketing strategies that further enhanced the branding of the company. </li>
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">waterless car wash services jamnagar 
</th>
                                            <th style="text-align: center;
    padding: 10px 5px;
    color: #777474;
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">waterless car services jamnagar
</th>
                                            <th  style="text-align: center;
    padding: 10px 5px;
    color: #777474;
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">waterless car washing services jamnagar
 </th>
                                            <th style="text-align: center;
    padding: 10px 5px;
    color: #777474;
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">doorstep car wash service jamnagar
</th>
                                            <th style="text-align: center;
    padding: 10px 5px;
    color: #777474;
