...
<section  class="testimonials banner_w3lspvt position-relative">
  ...
  <p class="text-center agileits agileinfo wthree w3-agileits" style="color: black;">Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum is simply dummy text of the printing<br> and typesetting industry.Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
    ...
    font-weight: 700;
    font-size: 38px;
    line-height: 41px;">ASO BASIC PLAN</span>
...
<li style="background: #cac6c6;text-decoration: line-through;">Press Release Writing</li>
<li>Blog Writing - 2</li>
<li style="background: #cac6c6">Review Writing - 7</li>
<li>Article Submission - 3</li>
<li style="background: #cac6c6;text-decoration: line-through;">Press Release Submission</li>
<li>Blog Submission - 2</li>
<li style="background: #cac6c6">Review Submission - 7</li>
<li>APK file Sharing - 5</li>
<li style="background: #cac6c6">Social Bookmarking - 10</li>
<li>App Video Submission (provided by client) - 5</li>
<li style="background: #cac6c6">App Video Promotion - 5</li>
<li>Initial Facebook Account Setup</li>
<li style="background: #cac6c6">Facebook Fan Page Setup for Apps</li>
<li>Facebook Posting 5/Month</li>
<li style="background: #cac6c6">Twitter Account Setup for Apps</li>
<li>Twitter Profile Design</li>
<li style="background: #cac6c6">Twitter Posting 5/Month</li>
<li>Linkedin Profile Creation for Apps</li>
<li style="background: #cac6c6">Weekly Linkedin Profile Updates</li>
<li>Linkedin Posting 5/Month</li>
<li style="background: #cac6c6">Instagram Fan Page Setup for Apps</li>
<li>Instagram Posting 5/Month</li>
...
<li style="background: #cac6c6">Press Release Writing</li>
<li>Blog Writing - 5</li>
<li style="background: #cac6c6">Review Writing - 15</li>
<li>Article Submission - 5</li>
<li style="background: #cac6c6">Press Release Submission</li>
<li>Blog Submission - 5</li>
<li style="background: #cac6c6">Review Submission - 15</li>
<li>APK file Sharing - 10</li>
<li style="background: #cac6c6">Social Bookmarking - 15</li>
<li>App Video Submission (provided by client) 10</li>
<li style="background: #cac6c6">App Video Promotion - 10</li>
<li>Initial Facebook Account Setup</li>
<li style="background: #cac6c6">Facebook Fan Page Setup for Apps</li>
<li>Facebook Posting 10/Month</li>
<li style="background: #cac6c6">Twitter Account Setup for Apps</li>
<li>Twitter Profile Design</li>
<li style="background: #cac6c6">Twitter Posting 10/Month</li>
<li>Linkedin Profile Creation for Apps</li>
<li style="background: #cac6c6">Weekly Linkedin Profile Updates</li>
<li>Linkedin Posting 10/Month</li>
<li style="background: #cac6c6">Instagram Fan Page Setup for Apps</li>
<li>Instagram Posting 10/Month</li>
<li style="background: #cac6c6">A/B Testing</li>
<li>Monthly Reporting</li>
