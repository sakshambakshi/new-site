...
<link rel="icon" href="favicon.ico" type="image/png">
        ...
        <link rel="canonical" href="https://www.digitalinfoways.com/web-design-case-study.php" />
...
<meta property="og:url" content="https:www.//digitalinfoways.com/web-design-case-study.php" />
...
<meta property="og:image" content="https:www.//digitalinfoways.com/digital-marketing-services.php" />
...
<section id="" style="background: black;">
    ...
    font-weight: 700;margin-bottom: 20px; ">Web Design Carwash Study Us</h2>
    <h2 style="text-align: center;
    color: white;
    font-size: 24px;
...
<section class="about-us banner_w3lspvt position-relative" >
    ...
    font-weight: 600;margin-bottom: 20px;margin-left: 25px;" >About Client</h3>
			<p style="text-align: justify; color: #676464;margin-left: 25px;">The proposed application by the client was a website portal that offers waterless car service at home and office. The major work served by the client was doing all types of services enlisted on their website without using water with the help of decent technology and strategies. The website needs to be more presentable and well designed with a proper description that definitely attracts more targeted audiences.     </div>
                  
			</div>
				<div class="col-md-6 ">
					<div class="img-block-head ">
                    <img src="img/case1.png" style="    width: 100%;
    height: 394px;">
                  </div>
				</div>
	</div>
	...
	<!-- new industry -->
<section class="about-us banner_w3lspvt position-relative" style="margin-top: -50px;" >
    <h2 class="text-center w3layouts w3 w3l w3ls"><span style="color: #fd8d01;">TECHNOLOGIES &  </span>INTEGRATIONS</h2>
...
<div class="home-industry-sec">
            ...
            <div class="home-industry clearfix">
                <ul>
                    <li>
                            ...
                            <div class="icon">
                                <picture>
                                    <source srcset="img/Shopify.png">
                                    <source srcset="img/Shopify.png">
                                    <img src="img/Shopify.png" style="width: 60px;">
                                </picture>                              
                            </div>
                            <h3>Shopify</h3>
                    ...
                    <li>
                            ...
                            <div class="icon">
                                <img src="img/php.png" alt="" style="width: 60px;">
                            </div>
                            <h3>PHP</h3>
                    ...
                    <li>
                            ...
                            <div class="icon">
                                <img src="img/eCommerce-1.png" alt="" style="width: 60px;">
                            </div>
                            <h3>eCommerce</h3>
                    ...
                    <li>
                            ...
                            <div class="icon">
                                <img src="img/facebook-1-2.png" alt="" style="width: 60px;">                             
                            </div>
                            <h3>Facebook</h3>
                    ...
                    <li>
                            ...
                            <div class="icon">
                                <img src="img/html5-2-2.png" alt="" style="width: 60px;">    
                            </div>
                            <h3>Html5</h3>
                    ...
                    <li>
                            ...
                            <div class="icon">
                                <img src="img/godaddy-SSL.png" alt="" style="width: 60px;">
                            </div>
                            <h3>GoDaddy SSL</h3>
                    ...
                    <li>
                            ...
                            <div class="icon">
                                <img src="img/JavaScript.png" alt="" style="width: 60px;">
                            </div>
                            <h3>Javascript</h3>
                    ...
                    <li>
                            ...
                            <div class="icon">
                                <img src="img/instagram-1.png" alt="" style="width: 60px;">
                            </div>
                            <h3>Instagram</h3>
                    ...
                    <li>
                            ...
                            <div class="icon">
                                <img src="img/ajax.png" alt="" style="width: 60px;">
                            </div>
                            <h3>AJAX</h3>
                    ...
                    <li>
                            ...
                            <div class="icon">
                                <img src="img/google-analytics.png" alt="" style="width: 60px;">
                            </div>
	...
	<section class="about-us banner_w3lspvt position-relative" style="margin-top:  -65px;">
     <h2 class="text-center w3layouts w3 w3l w3ls"><span style="color: #fd8d01;">Core </span>Features</h2>
    <span class="about-line"></span>
        <div class="container ">
            <div class="row " style="background: #eae7e7;
    border-top: 3ps solid gray;
    border-top: 3px solid #fd8d01;
    text-align: justify;
    border-radius: 13px">
                <div class="col-md-6">
    ...
    color: #676464;margin-bottom: 20px;">
                        ...
                        <li>A home page with some introduction message about the services provided by the client.</li>
                        <li>It contains a login functionality that allows individuals to create their own personal profile.</li>
                        <li>Having features about their statistics, the number of cars they washed, and about some satisfied customers. </li>
                        <li>A brief description of their company, about their employees, and about their services in the about us section.</li>
                        <li>Enlisted all types of external and internal services related to the car wash separately for better understanding.</li>
                        <li>It contains the WhatsApp appointment feature and detailed information about the process of doing the car wash.</li>
    ...
    padding: 2px 40px;
    color: #676464;">
                        <li>It's also designed to receive rates from clients about their work.</li>
<li>It presents the feature of getting detailed feedback from the client about their experiences getting services from the company.</li>
<li>Having the section contact us that allows an individual to contact the team at any moment for details.</li>
              ...
              <div class="content-body">
                <div class="quote-section">
                  <blockquote style="border: none;">
                    <span style="float: left;line-height: 20px;"><img src="img/bg-quote-up.png"></span>
                    <p class="content-quote" style="    text-align: center;
    margin-top: 38px;
    font-size: 17px;
    line-height: 33px;
    padding: 25px 42px;">Brilliant Approach! The guys at Digitalinfoways just took hold of the project and calmly walked me through it. They built me the engine I had hoped for to bring me more prospects and it has had a dramatic impact on my bottom line.</p>
<p class="zero-p" style="text-align: center;">&nbsp;</p>
<p style="text-align: center; font-style: normal;">—Rakesh, Marketing Manager</p>
<span style="float:right;"><img src="img/bg-quote-bottom.png"></span>
                  </blockquote>  
