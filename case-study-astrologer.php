...
<section class="about-us banner_w3lspvt position-relative" style="margin-top:  440px;">
    ...
    font-size: 24px;">c</h4>
					<p style="text-align: justify; color: #676464;margin-left: 25px;">Astrologer PanchMukhiJyotish is the number one astrologer in Ahmedabad that facilitates services like palm reading, family problems, providing different yantras, vashikaran, and gems. 
Despite the number one astrologer in Ahmedabad, they were unable to have an online reputation and presence. They faced problems in expanding their clientele and leads. Businesses suffered slow progress and less return on investment. 
</p>
                  </div>
    ...
    <h4 style=" text-align: justify;
    font-size: 16px;padding:3px 0px;color: #676464; "></h4>
                    <ul style="text-align: justify;
    font-size: 16px;
    padding: 2px 40px;
    color: #676464;margin-bottom: 20px;">
                        <li> • The Site was not user-friendly  </li>
<li> • No proper keywords used.   </li>
<li> • No URL Strategy was there to uplift the marketing of the services provided by the astrologer.   </li>
    ...
    font-weight: 500;margin-bottom: 20px;margin-left: 25px;" >Strategic SEO Campaigns:</h3>
                   <ul style="text-align: justify;
    font-size: 16px;
    padding: 2px 40px;
    color: #676464;">
  <li>                      • We created a search-friendly website that boosted the traffic.  </li>
  <li>    • We used the keyword strategy that developed an integrated site.  </li>
  <li>    • All the SEO monitoring was done to check and fix all the issues.  </li>
  <li>    • We published the fresh content on the website stating all the services provided by them.  </li>
  <li>    • We added calls to action in the website content.  </li>
  <li>    • We handled social media and ads for promotion for the right audience across India.  </li>
    ...
    padding: 2px 40px;
          color: #676464;">
                           <li> • Their sales skyrocketed; now they are getting clients every day.  </li>
    <li>  • Improved ranking helped in the increase in website visitors.  </li>
    <li>  • Content and site architecture increasedtraffic.  </li>
    <li>  • Improved keywords and site optimization helped in reaching the target audience increasing the return on investment. </li>
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">famous jyotish in Ahmedabad
</th>
                                            <th style="text-align: center;
    padding: 10px 5px;
    color: #777474;
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">jyotish in Ahmedabad
</th>
                                            <th  style="text-align: center;
    padding: 10px 5px;
    color: #777474;
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">famous astrologer in Ahmedabad
</th>
                                            <th style="text-align: center;
    padding: 10px 5px;
    color: #777474;
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">Enemy Problem Solution
</th>
                                            <th style="text-align: center;
    padding: 10px 5px;
    color: #777474;
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">Best Astrologer in Ahmedabad
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">Best Astrologer in USA
