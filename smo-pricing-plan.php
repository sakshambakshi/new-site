...
<section  class="testimonials banner_w3lspvt position-relative">
  ...
  <p class="text-center agileits agileinfo wthree w3-agileits" style="color: black;">Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum is simply dummy text of the printing<br> and typesetting industry.Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
    ...
    <!--padding-top: 10px;">Express</h4>-->
              ...
              <li>  Social Updates - 10  </li>
              <li>  Post Sharing in Groups - 10  </li>
              <li style="text-decoration: line-through;">  Group Creation / Groups Join  </li>
              <li style="text-decoration: line-through;">  Targeted Page Likes  </li>
              <li>  Call To Action Button  </li>
              <li style="text-decoration: line-through;">  Facebook Reviews Posting  </li>
              ...
              <li style="text-decoration: line-through;">  Image Tagging to Friends/Followers  </li>
              <li>  Targeted Linkedin Connection  </li>
              <li>  Company Page Creation  </li>
              <li style="text-decoration: line-through;">  Showcase and Busines page creation  </li>
              <li style="text-decoration: line-through;">  Company Page Follower Increase  </li>
              <li>  Company Page Creative Banner  </li>
               <li style="text-decoration: line-through;"> Profile Connection Build up  </li>
              <li>  Linkedin Pulse Posting  </li>
               <li> Video Sharing (provided by client)  </li>
               <li> Google Review Postings  </li>
               <li style="text-decoration: line-through;"> Polls Creation & Management  </li>
               <li> Video Title & Meta Optimization  </li>
               <li> Thumbnail Creative for Videos  </li>
               <li> Youtube Subscribers  </li>
               <li style="text-decoration: line-through;"> Youtube Discussion Posting  </li>
               <li> Youtube Video Views  </li>
               <li style="text-decoration: line-through;"> Comment Moderation  </li>
               <li> Pins Posted  </li>
               <li> Followers  </li>
