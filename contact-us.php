...
<!--[if gt IE 8]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <title>Contact Us - Digitalinfoways</title>
        ...
        <link rel="canonical" href="https://www.digitalinfoways.com/contact-us.php" />
...
<meta property="og:title" content="Contact Us for digital marketing services"/>
<meta property="og:type" content="SEO and Digital Marketing Company" />
<meta property="og:site_name" content="Digitalinfoways" />
<meta name="robots" content="index, follow" />
<meta property="og:url" content="https://www.digitalinfoways.com/contact-us.php" />
<meta property="og:description" content="A full service global digital marketing agency offering innovative site designing, mobile, and e-commerce development content creation, SEO, DMM all major services."/>
<meta property="og:image" content="https://www.digitalinfoways.com/contact-us.php" />
...
<script type='text/javascript' src='assets/js/menu.js' defer onload=''></script>
        ...
        <section id="service-slider " class="bg-img-7" style="padding-left: 10px;" >
    ...
    font-size: 42px;
    margin-top: 200px;
    font-weight: 700;margin-bottom: 20px; ">Take The Next Leap Towards The<br>
    <span style="color: #f37e05;font-size: 45px;">Digital Transformation </span>Of Your Business</h2>
      <div class="row " style="max-width:100%;height: 600px;box-shadow: 0 30px 30px 0 rgba(0, 0, 0, 0.08);background: white;height: 700px;margin-top:170px;">
        <h1 style="text-align: center;
    color: black;
    font-size: 35px;
    font-weight: 500;
    margin-bottom: 20px; line-height: 51px;padding-top: 40px;padding-bottom: 40px;">By filling the form you're entitled to
          <br>
<span style="color: #f37e05;font-size: 40px;font-weight: 700;">Free Consultation*<span></h1>

      <div class="col-md-6" >
        <form action="https://digitalinfoways.com/thank-you.php" method="post">
          <div class="row">
            <div class=" col-md-6 " >
              <input type="tel" class="" placeholder="your name*" / style="    
    height: 58px;
    padding: 12px 10px;
    text-transform: capitalize;
    font-family: inherit;width: 93%;border-radius: 4px;border-top: none;
    border-left: none;border-right: none;border-bottom: 1px solid #d8d4d4;" required>
            </div>
            <div class=" col-md-6 " >
              <input type="tel" class="" placeholder=" your email*" / style="    
    height: 58px;border-radius: 4px;border-top: none;
    border-left: none;border-right: none;border-bottom: 1px solid #d8d4d4;
    padding: 12px 10px;border-radius: 4px;
    text-transform: capitalize;
    font-family: inherit;width: 93%;" required>
            </div>
          </div><!--row1-->
          <br>
          <div class="row">
            <div class=" col-md-6 ">
            <input type="tel" class="" placeholder="Your Phone*" / style="    
    height: 58px; border-radius: 4px;border-top: none;
    border-left: none;border-right: none;border-bottom: 1px solid #d8d4d4;
    padding: 12px 10px;border-radius: 4px;
    text-transform: capitalize;
    font-family: inherit;width: 93%;" required>
            ...
            <div class=" col-md-6 " >
              <select name="" class="form-control effect-16" tabindex="0" id="ContactsBudget" style="    
    height: 58px; border-radius: 4px;border-top: none;
    border-left: none;border-right: none;border-bottom: 1px solid #d8d4d4;
    padding: 12px 10px;
    text-transform: capitalize;border-radius: 4px;
    font-family: inherit; width: 93%;background: none;" required>
...
<br>
      <div class="row">
            <div class=" col-md-12 cons2" >
              <input type="tel" class="" placeholder="message*" / style="    
    height: 58px;border-radius: 4px;border-top: none;
    border-left: none;border-right: none;border-bottom: 1px solid #d8d4d4;
    padding: 12px 10px;
    text-transform: capitalize;border-radius: 4px;
    font-family: inherit;width:100%; " required>
            </div>
          </div>
          <br>
          <div class="row">
            <div class=" col-md-12 cons2" >
              <input type="file" class="" placeholder="Browse file" / style="    
    ...
    font-family: inherit;width: 100%;" required>
            ...
            <label style="margin-top: 20px;"><input type="checkbox" name="" value="Yes, please. I would like to hear about offers and services." style="margin-right: 8px;"><span class="wpcf7-list-item-label" >Yes, please. I would like to hear about offers and services.</span></label>
            <br>
            <div class="row">
...
<div class="col-md-6">
    ...
    font-weight: 600;
    font-size: 22px;text-decoration: underline;">Select Your Requirment</h1>
    <div class="row">
      <div class="col-md-6">
        <label style="margin-top: 20px;"><input type="checkbox" name="" value="Yes, please. I would like to hear about offers and services." style="margin-right: 8px;"><span class="wpcf7-list-item-label" >Digital Marketing</span></label><br>
        <label style="margin-top: 20px;"><input type="checkbox" name="" value="Yes, please. I would like to hear about offers and services." style="margin-right: 8px;"><span class="wpcf7-list-item-label" >SEO</span></label><br>
        <label style="margin-top: 20px;"><input type="checkbox" name="" value="Yes, please. I would like to hear about offers and services." style="margin-right: 8px;"><span class="wpcf7-list-item-label" >Social Media Marketing</span></label>
        
      </div>
      <div class="col-md-6">
         <label style="margin-top: 20px;"><input type="checkbox" name="" value="Yes, please. I would like to hear about offers and services." style="margin-right: 8px;"><span class="wpcf7-list-item-label" >Web Design</span></label>
        <label style="margin-top: 20px;"><input type="checkbox" name="" value="Yes, please. I would like to hear about offers and services." style="margin-right: 8px;"><span class="wpcf7-list-item-label" >Web Development</span></label><br>
        <label style="margin-top: 20px;"><input type="checkbox" name="" value="Yes, please. I would like to hear about offers and services." style="margin-right: 8px;"><span class="wpcf7-list-item-label" >ASO</span></label>
        
      </div>

    </div>
    <hr style="border-top: 1px solid #a09e9e;">
...
<div id="page" style="margin-top: 900px;" class="hidden-lg hidden-md">
		<section class="about-us">
      <h2 class="text-center w3layouts w3 w3l w3ls"><span style="color: #fd8d01;">CORPORATE</span> OFFICE</h2>
  <span class="about-line"></span>
				<div class="container">
					<div class="row" style="padding-top: 20px;">
            <div class="col-md-12 text-center">
              <img src="img/INDIAs.jpg">
              <h1 style="    color: black;
    text-transform: uppercase;
    font-size: 20px;
    font-weight: 600;
...
">India</h1>
    ...
    font-weight: 600;
    padding-bottom: 8px;">303, Devarsh Sopan, Nr.Delhi Darwaja <br>Opp, B.G Tower, Ahmedabad - 380001</h5>
              <h5 style="font-size: 15px;
    font-weight: 600;
    padding-bottom: 8px;">+91-9909054700,
              7383507579</h5>
            </div>
            </div>
			</div>
...
<div id="page" style="margin-top: 250px;" class="hidden-xs hidden-sm">
		<section class="about-us">
      <h2 class="text-center w3layouts w3 w3l w3ls"><span style="color: #fd8d01;">CORPORATE</span> OFFICE</h2>
  <span class="about-line"></span>
				<div class="container">
