...
<section class="about-us banner_w3lspvt position-relative" style="margin-top:  440px;">
    ...
    font-weight: 600;margin-bottom: 20px;margin-left: 25px;" >The Challenge:</h3>
    <h4 style="    text-align: justify;
    font-size: 24px;">Increase Ranking & Organic Traffic</h4>
					<p style="text-align: justify; color: #676464;margin-left: 25px;">The client needed to fetch more sales from his online store and to increase the brand awareness over the internet. The major focus was to get first page rankings and drive organic traffic to have the maximum online visibility.</p>
                  </div>
                  <div class="img-block-head " style="padding-top: 40px;">
                    <h3  style="font-size: 32px; text-align: left;
    font-weight: 600;margin-bottom: 20px;margin-left: 25px;" >The Solution:</h3>
    <h4 style=" text-align: justify;
    font-size: 16px;padding:3px 0px;color: #676464; ">We conducted a rigorous in depth analysis  and dig out the following:</h4>
                    <ul style="text-align: justify;
    font-size: 16px;
    padding: 2px 40px;
    color: #676464;margin-bottom: 20px;">
                        <li>Client’s  website was neither search engine friendly nor user friendly.</li>
                        <li>The internal pages of the website had non-optimized content.</li>
                        <li>It had no organic search rankings and very less organic traffic.</li>
                        <li>The website content was not properly interlinked.</li>
                        <li>The meta tags of the website were not keyword optimized.</li>
                        <li>The number of relevant and quality backlinks were very only a few in number.</li>
    ...
    font-weight: 500;margin-bottom: 20px;margin-left: 25px;" >Strategic SEO Plan:</h3>
                   <ul style="text-align: justify;
    font-size: 16px;
    padding: 2px 40px;
    color: #676464;">
                        <li>Make the website search engine friendly.</li>
<li>Implement a strong link building campaign.</li>
<li>Social media exposure.</li>
<li>Find and focus on the most relevant keywords in the competitive business.</li>
                        
                    </ul>
                  </div>
                  <div class="img-block-head " style="padding-top: 40px;">
                    <h3  style="font-size: 25px; text-align: left;
    font-weight: 500;margin-bottom: 20px;margin-left: 25px;" >SEO Campaign at work:</h3>
    <ul style="text-align: justify;
    font-size: 16px;
    padding: 2px 40px;
    color: #676464;">
                        <li>The first and the foremost task was restructuring the client’s website. This required to include relevant keywords, alt texting pictures, page titles, meta tags and descriptions and creating the internal links.</li>
                        <li>We then added some quality content to improve the reachability.</li>
                        <li>We have then done the internal linking to make for establishing site architecture and spreading link equity. </li>
                        <li>Next, we asked client for the fresh photographs  of their products and stores by a professional. </li>
                        <li>Finally, a consistent link building process was started to improve and increase the backlinks.</li>
