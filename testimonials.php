...
<meta property="og:url" content="testimonials.php/" />
...
<meta property="og:image" content="testimonials.php/" />
...
">
  ...
  <section class="certseo-clients about-us banner_w3lspvt position-relative">
    ...
    height: 127px;
    padding: 18px;">
                  <img class="img-responsive" src="img/testimonial/logo1.png" alt="" style="width: 90%;
    height: 85px;
    ...
    background: #d61b1b;"> 
              ...
              <div class="col-md-3">
                <div class="image" style="border-right:1px solid #cac9c9;">
                  <img class="img-responsive" src="img/testimonial/logo.png" alt=""  style="width: 91%;
    height: 142px;
    padding: 20px 16px;"> 
                </div>
             </div>
             <div class="col-md-3">
                <div class="image" style="border-right: 1px solid #cac9c9;">
                  <img class="img-responsive" src="img/testimonial/logo2.png" alt="" style="width: 90%;
    height: 146px;
    padding: 22px 16px;"> 
                </div>
              </div>
              <div class="col-md-3">
                <div class="image" style="border-right:1px solid #cac9c9;">
                  <img class="img-responsive" src="img/testimonial/logo3.png" alt="" style="width: 91%;
    height: 149px;
    padding: 18px 16px;"> 
                </div>
              </div>
