...
<link rel="icon" href="favicon.ico" type="image/png">
    ...
    <title>SEO Reviews and Client Testimonial - Digitalinfoways</title>
    <meta name="description" content="Read SEO client testimonials - What actual customers have to say about our services.">
        ...
        <link rel="canonical" href="https://www.digitalinfoways.com/testimonials.php" />
...
<meta property="og:url" content="https://www.digitalinfoways.com/testimonials.php/" />
...
<meta property="og:image" content="https://www.digitalinfoways.com/testimonials.php/" />
...
<section  class="bg-img-9" >
    ...
    font-weight: 700; ">INGIC REVIEWS help you<br> make a calculated and <br>right decision.</h2>
      <p style="text-align: left;
    font-size: 21px;
    color: white;line-height: 30px;">Take a moment and read reviews we've received from our<br>
fabulous clients around the world.</p>
    </div>
  </div>
                    </div>
...
<section class="about-us banner_w3lspvt position-relative">
 <div class="container ">
  <h2 class="text-center w3layouts w3 w3l w3ls"><span style="color: #fd8d01;">Why Client Experience is <br> </span>  Important to Us?</h2> 
  <span class="about-line"></span>
   
  
  <p class="text-center w3layouts w3 w3l w3ls">At INGIC, our main aim is to foster a culture that not only focuses on providing innovative solutions to present technology ecosystem but<br> also reinvent the future. On one hand, while we strive to outperform excellence in our processes and business behaviors for unceasing <br>success, on other hand, we place customer satisfaction as the utmost priority.</p>
	...
	<!--certificate-->
  <!--certificate-->
  <section class="certseo-clients " style="background: #f3f3f3">
    <div class="container">
      <div class="row">
        <div class="col-md-4">
            <div class="image" style="    background: white;
    padding: 33px 24px;">
                  <h4 class="awd2" style="font-size: 24px;
    color: #fb2224;
    font-weight: 600;
    padding: 0 0 5px 0;
    line-height: 1;
    font-family: Poppins, sans-serif;">Outstanding services</h4>
                  <!--<p class="awd3">Overall Rating from 49 Users</p>-->
                                 <div class="ss_new">

<div class="rate0" style="text-align: left;">
<span><img width="19" height="23" src="img/stars.png" alt="Rating"></span>
<span><img width="19" height="23" src="img/stars.png" alt="Rating"></span>
<span><img width="19" height="23" src="img/stars.png" alt="Rating"></span>
<span><img width="19" height="23" src="img/stars.png" alt="Rating"></span>
<span><img width="19" height="23" src="img/stars.png" alt="Rating"></span>
    ...
    font-weight: 400;
    padding: 0 0 10px 0;
    font-family: Poppins, sans-serif;">My friend recommended INGIC when I wanted a website for my health and fitness services. I contacted them through website and got an instant response. They sent me initial designs and I loved them. The website is live now and getting traffic as it is easy to use, with outstanding imagery and mobile compatibility. The project I was in contact with is a very decent and polite guy and patiently listened to my feedback and made sure that it is applied as I want to. I am quite happy with the services INGIC has provided.</p>
                  <div class="row" style="margin-top: 13px;">
                    <div class="col-md-3" >
                  <img class="img-responsive" src="img/testimonial/1.jpg" alt="" style="box-shadow: 0 -8px 30px 0 rgba(4, 4, 4, 0.08);    border-radius: 19px;
">
                </div>
                <div class="col-md-3" >
                  <hr style="color: #d61515;
    border: 1px solid;
    margin-top: 22px;">
                </div>
                 <div class="col-md-6">
    ...
    line-height: 1;
    position: relative; 
    font-family: Poppins, sans-serif;">Margy Duclos
</h5>
                 </div>
                </div>
                </div>
...
">
  ...
  <section class="certseo-clients about-us banner_w3lspvt position-relative">
    <div class="container">
      <h2 class="text-center w3layouts w3 w3l w3ls" style="margin-bottom: 40px;"><span style="color: #fd8d01;">Ranked on Top by Reputed <br> </span> Review Platforms</h2> 
      <span class="about-line"></span>
        <div class="row">       
           <div class="col-md-3">
                <div class="image" style="border-right: 1px solid #cac9c9;
    height: 127px;
    padding: 18px;">
                  <a href="http://www.dmaticsolutions.com/"><img class="img-responsive" src="img/testimonial/logo1.png" alt="" style="width: 90%;
    height: 85px;
    ...
    background: #d61b1b;"> </a>
              ...
              <div class="col-md-3">
                <div class="image" style="border-right:1px solid #cac9c9;">
                 <a href="http://www.goldenlinkspark.com/"> <img class="img-responsive" src="img/testimonial/logo.png" alt=""  style="width: 91%;
    height: 142px;
    padding: 20px 16px;"></a> 
                </div>
             </div>
             <div class="col-md-3">
                <div class="image" style="border-right: 1px solid #cac9c9;">
                  <a href="https://www.jellybeancreative.com/"><img class="img-responsive" src="img/testimonial/logo2.png" alt="" style="width: 90%;
    height: 146px;
    padding: 22px 16px;"> </a>
                </div>
              </div>
              <div class="col-md-3">
                <div class="image" style="border-right:1px solid #cac9c9;">
                 <a href="https://www.localseowork.com/"> <img class="img-responsive" src="img/testimonial/logo3.png" alt="" style="width: 91%;
    height: 149px;
    padding: 18px 16px;"> </a>
                </div>
              </div>
