...
<section id="" style="background: black;">
    ...
    font-weight: 700;margin-bottom: 20px; ">Web Design Dmatic Study Us</h2>
    <h2 style="text-align: center;
    color: white;
    font-size: 24px;
...
<section class="about-us banner_w3lspvt position-relative" >
    ...
    font-weight: 600;margin-bottom: 20px;margin-left: 25px;" >About Client</h3>
			<p style="text-align: justify; color: #676464;margin-left: 25px;">The proposed application by the client was a website portal that offers bulk SMS services for the business. The major work of the company is  SMS Service providing, SEO Service, PPC Advertising, Email Marketing, etc that helps to increase your business revenue. As the website is enlisted with a vast type of developing services so it definitely needs a top-notch website designing for a better explanation. </div>
...
<div class="home-industry-sec">
    ...
    color: #676464;margin-bottom: 20px;">
                       <li>  A home page with a welcome gallery contains details about the services they provided for business development.</li>
<li> Using the ASAP.NET framework for better web development to produce dynamics web pages.</li>
<li> Use of Web Servers IIS 7 makes an easy and accessible website structure that represented a clear showcase with the respective work sample.</li>
<li> It contains the contact us page that allows everyone to send their queries or to know about the services.</li>
<li> Having the features to hire a marketing expert.</li>
<li> Clearly representation of their expertise fields in the figure for better understanding.</li>
    ...
    padding: 2px 40px;
    color: #676464;">
                    <li> A brief introduction section about their company and services that represent more about them.</li>
<li> It contains the inquiry section that allows you to send some brief details about yourself before asking for any service.</li>
<li> The website contains all types of linked social media for getting socialized.</li>
