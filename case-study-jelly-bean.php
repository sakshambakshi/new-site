...
<link rel="icon" href="favicon.ico" type="image/png">
    ...
    <title>Google Adwords(PPC), SEO and ASO Case Studies - Digitalinfoways</title>
    <meta name="description" content="The internet marketing Case studies highlighting recent successes work in PPC, SEO, ASO and Social Media Marketing.">
        ...
        <link rel="canonical" href="https://www.digitalinfoways.com/case-study.php" />
...
<meta property="og:title" content="Digital Infoways - Must read case studies of Marketing and Development" />
<meta property="og:type" content="SEO and Digital Marketing Company" />
<meta property="og:site_name" content="Digitalinfoways" />
<meta name="robots" content="index, follow" />
<meta property="og:url" content="https://www.digitalinfoways.com/case-study.php" />
<meta property="og:description" content="Digital Infoways is a leading digital marketing company in India, We put inseparable part of the case study which help you to generate more leads for Designing, Development, and Marketing with content."/>
<meta property="og:image" content="https://www.digitalinfoways.com/case-study.php" />
...
<section  style="background: black;">
    ...
    font-weight: 700;margin-bottom: 20px; ">SEO  Jelly bean Case Study Us</h2>
    <h2 style="text-align: center;
    color: white;
    font-size: 24px;
    font-weight: 400;margin-bottom: 35px;">Vapor Source – Electronic Cigarette Manufacturer & Seller</h2>
      <div class="row bg-img-12" style="max-width:100%;height: 600px;box-shadow: 0 30px 30px 0 rgba(0, 0, 0, 0.08);
    border:2px solid blue;border-radius: 10px;">
        ...
        ==================================== -->
    <!-- about -->
<section class="about-us banner_w3lspvt position-relative" style="margin-top:  440px;">
	
		<div class="container ">
			<div class="row ">
				<div class="col-md-6">
				<div class="img-block-head ">
					<h3  style="font-size: 32px; text-align: left;
    font-weight: 600;margin-bottom: 20px;margin-left: 25px;" >About Client:</h3>
    <h4 style="    text-align: justify;
    font-size: 24px;"></h4>
					<p style="text-align: justify; color: #676464;margin-left: 25px;">Jelly Bean Creation is one of the leading exhibition designers that provides the client the stunning and unique designs for exhibitions and trade show events that leave the viewer’s astounding.  
The United Kingdom based company provides the complete exhibition services like exhibition designers, exhibition stand design, exhibition contractor, Exhibition booth design, booth builder, stand manufacturers, and many more. 

</p>
                  </div>
                  <div class="img-block-head " style="padding-top: 40px;">
                    <h3  style="font-size: 32px; text-align: left;
    font-weight: 600;margin-bottom: 20px;margin-left: 25px;" >Objective</h3>
    <h4 style=" text-align: justify;
    font-size: 16px;padding:3px 0px;color: #676464; ">Jelly Bean Creative working with collaboration with booth builders and contractors assisted many exhibitions like Senegal Tourism and Leisure, Ice Totally Gaming, Citipost Parcels, Skill rock Online Gaming, and many more to increase its sale at the show by furnishing their show with the innovative design. </h4>
                    <ul style="text-align: justify;
    font-size: 16px;
    padding: 2px 40px;
    color: #676464;margin-bottom: 20px;">
    ...
    font-weight: 500;margin-bottom: 20px;margin-left: 25px;"> Challages:</h3>
                   <ul style="text-align: justify;
    font-size: 16px;
    padding: 2px 40px;
    color: #676464;">
Although they have the world-class designs available with them but still was not getting enough leads to the unscrupulous website design and its content. 

What services they are providing, what they achieved to date, how they are helping the clients was not appropriately mentioned on the website. They have a diverse and superb portfolio that is necessary for the lead-generation. 

The website design was at the outdate platform that nobody prefers to use in this competitive world. 
                  ...
                  <div class="img-block-head " style="padding-top: 40px;">
                    <h3  style="font-size: 25px; text-align: left;
    font-weight: 500;margin-bottom: 20px;margin-left: 25px;" >Our Obligation:</h3>
    <ul style="text-align: justify;
    font-size: 16px;
    padding: 2px 40px;
          color: #676464;">
                              <li> •  We provide the digital marketing services to enhance the visibility of the website by ranking the  for the industry-related keyword.</li>
   <li> • We used the latest technology to design the website and provided the complete SEO services. </li>
   <li> • We assisted in the planning and monitoring of the content. </li>
   <li> • We conducted a competitive-analysis, based on that creates the website with the best design and the content. </li>
   <li> • We understood the target audience in a way, and help them explore more digital marketing channels to increase their leads.</li>
	...
	<!-- Work -->
			<section id="service" class="about-us " style="margin-top: -30px;">
                <h2 class="text-center w3layouts w3 w3l w3ls">The Google<span style="color: #fd8d01;"> Page 1  </span>Rankings</h2>
						...
						<div class="col-md-12 col-sm-12 col-xs-12 text-center">
                            <div class="tables">
							   <table style="    width: 100%;">
                                    <tr class="tebs1">
                                        <th  style="text-align: center;padding: 10px 5px;font-size: 19px;text-align: center;padding: 10px 5px;    color: #545252;">Keywords</th>
                                        <th style="text-align: center;padding: 10px 5px;font-size: 19px;text-align: center;padding: 10px 5px;    color: #545252;">Ranking</th>
                                    </tr>
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">Exhibition Stand Manufacturing Companies
</th>
                                            <th style="text-align: center;
    padding: 10px 5px;
    color: #777474;
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">Exhibition Stand Manufacturing Company
</th>
                                            <th  style="text-align: center;
    padding: 10px 5px;
    color: #777474;
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">Museum Gallery Designers
</th>
                                            <th style="text-align: center;
    padding: 10px 5px;
    color: #777474;
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">Point of Display Units
</th>
                                            <th style="text-align: center;
    padding: 10px 5px;
    color: #777474;
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">Exhibition Stand Supplier
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">Point Of Sale Display Stands
