...
<section  style="background: black;">
    ...
    font-weight: 700;margin-bottom: 20px; ">SEO Case Study Us</h2>
    <h2 style="text-align: center;
    color: white;
    font-size: 24px;
...
The website design was at the outdate platform that nobody prefers to use in this competitive world. 
   ...
   <li> • We understood the target audience in a way, and help them explore more digital marketing channels to increase their leads.</li>
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">Surefire Vapor</th>
                                            <th style="text-align: center;
    padding: 10px 5px;
    color: #777474;
    font-family: inherit;
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">Authentic Mech Mods</th>
                                            <th  style="text-align: center;
    padding: 10px 5px;
    color: #777474;
    font-family: inherit;
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">Mechanical Mods Authenctic</th>
                                            <th style="text-align: center;
    padding: 10px 5px;
    color: #777474;
    font-family: inherit;
