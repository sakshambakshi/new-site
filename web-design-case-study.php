...
<section id="" style="background: black;">
    ...
    font-weight: 700;margin-bottom: 20px; ">Web Design Case Study Us</h2>
    <h2 style="text-align: center;
    color: white;
    font-size: 24px;
...
<section class="about-us banner_w3lspvt position-relative" >
    ...
    font-weight: 600;margin-bottom: 20px;margin-left: 25px;" >TESSEMAE’S</h3>
			<p style="text-align: justify; color: #676464;margin-left: 25px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse porta erat sit. Suspendisse porta erat sit amet eros sagittis, quis hendrerit libero aliquam. Fusce semper augue ac dolor efficitur.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse porta erat sit. Suspendisse porta erat sit amet eros sagittis, quis hendrerit libero aliquam. Fusce semper augue ac dolor efficitur. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse porta erat sit.</p>
                  </div>
...
<div class="home-industry-sec">
    ...
    color: #676464;margin-bottom: 20px;">
                        <li>Client’s  website was neither search engine friendly nor user .</li>
