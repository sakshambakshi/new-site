...
<link rel="icon" href="favicon.ico" type="image/png">
        ...
        <title>Thanks you - Digitalinfoways</title>
        <link rel="canonical" href="https://www.digitalinfoways.com/thank-you.php" />
        <meta property="og:title" content="One of the best Digital Marketing Company in India | Digital Infoways"/>
        <meta property="og:description" content="looking for SEO and Web Development Services? We serve results-driven development and marketing service which is useful for clients' brand awareness and business inspires."/>
        <meta property="og:url" content="https://www.digitalinfoways.com/thank-you.php" />
...
<section id="service-slider" class="bg-img-13" >
    ...
    font-weight: 700; "><span style="color: #f37e05">Thank</span> You</h2>
        ...
        ==================================== -->
        <!-- about -->
<section class="about-us banner_w3lspvt" style="padding-top: 60px;background: #fbf3e2;padding-bottom: 60px;">
	
	<h2 class="text-center w3layouts w3 w3l w3ls" style="margin-bottom: 30px;"><span style="color: #fd8d01;">Digital DEVELOPMENT </span> BELIEVES<br>
IN TRUE BOND RELATIONSHIP, THAT ADMIRES SUCCESS </h2>
	<span class="about-line"></span>
	
		<div class="container ">
			<div class="row ">
                <div class="col-md-12 tsl">
                    <div class="col-md-5 ">
                    <img src="img/thank2.png" alt="" class="img-fluid"  style="    width: 300px;
    ...
    padding: 22px 5px;
    font-family: inherit;
    font-size: 18px;">Our consultant will reach you shortly with Digitalinfoways Mutual NDA to secure your idea/details.
						</p>
                        <p style="text-align: justify;
    padding: 10px 5px;
    font-family: inherit;
    font-size: 18px;">
Our consultant will reach you shortly with Evince's Mutual NDA to secure your idea/details.

Please download our company's profile for more information:
                        </p>
                        <p style="float: left;margin-top: 20px;margin-left: 5px;color: white;"> 
                            
                       
                        <a href="uploads/digital-info-development.pdf" class="downloads" title="Company Profile" target="_blank" style="color: white;">Company Profile <br><span style="font-size: 18px;font-weight: 300;">Download Now</span></a>
 </p>
