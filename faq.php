...
<!--[if gt IE 8]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <title>Search Engine Optimization (SEO) FAQs - Digitalinfoways</title>
    <meta name="description" content="Have any questions regarding seo, ppc, aso? Here are answers to some common questions about search engine optimization.">
...
<section class="bg-img-13" >
    ...
    font-weight: 700; "><span style="color: #f37e05">FA</span>Q<span style="color: #f37e05">+</span></h2>
...
<section class="testimonials banner_w3lspvt position-relative">
    ...
    <p class="text-center agileits agileinfo wthree w3-agileits" style="color: black;">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
</div>
    <div class="container">
        <div class="row">
            <div class="col-md-6">
