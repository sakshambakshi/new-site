...
<section class="about-us banner_w3lspvt position-relative" style="margin-top:  440px;">
    ...
    font-size: 24px;">c</h4>
					<p style="text-align: justify; color: #676464;margin-left: 25px;">Dmatic Solution is the SEO Service company, based out in Gujarat, that provides the bulk SMS and E-mail services. 
The company faced the problem of generating traffic on the website and the Google ranking. Although they are providing solitary services still they were unable to 
</p>
                  </div>
                  <div class="img-block-head " style="padding-top: 40px;">
                    <h3  style="font-size: 32px; text-align: left;
    font-weight: 600;margin-bottom: 20px;margin-left: 25px;" >Our Solution and Approach</h3>
    <h4 style=" text-align: justify;
    font-size: 16px;padding:3px 0px;color: #676464; ">We ushered the thorough analysis of every page and concluded that:</h4>
                    <ul style="text-align: justify;
    font-size: 16px;
    padding: 2px 40px;
    color: #676464;margin-bottom: 20px;">
   <li>                          •  We found that the website content was out-dated which was not generating enough traffic.  </li>
   <li>   • A low link count was observed on all the pages.  </li>
   <li>   • The landing page was not optimized.  </li>
   <li>   • Lack of adequate backlink.  </li>
    ...
    padding: 2px 40px;
    color: #676464;">
   <li>     • We assisted in website revamping with the proper optimization of the business page.  </li>
   <li>     • Managed the content and blog at the website with the pertinent keywords.  </li>
   <li>     • We handled their social media pages with engaging content by targeting the right audience.  </li>
   <li>     • We generated the backlink to improve their visibility at Google search. </li>
   <li>     • More focused competitive terms were targeted to improve visibility.  </li>
                  ...
                  <div class="img-block-head " style="padding-top: 40px;">
                    <h3  style="font-size: 25px; text-align: left;
    font-weight: 500;margin-bottom: 20px;margin-left: 25px;" >Business Impacts:</h3>
    <ul style="text-align: justify;
    font-size: 16px;
    padding: 2px 40px;
          color: #676464;">
  <li>                             •  The content got viral on the social media platform that helped increase lead generation and branding of the company.  </li>
  <li>  • The proper optimization and backlinks generated traffic that enhanced the sales of the company. </li>
  <li>  • There was a sharp increase in the traffic followed by the conversions and Return on investment.  </li>
  <li>  • Strategic links improved visibility and Google ranking. </li>
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">Bulk sms servie provider in ahmedabad
</th>
                                            <th style="text-align: center;
    padding: 10px 5px;
    color: #777474;
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">Facebook Marketing Company Ahmedabad
</th>
                                            <th  style="text-align: center;
    padding: 10px 5px;
    color: #777474;
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">Voice Call Service Provider Ahmedabad
</th>
                                            <th style="text-align: center;
    padding: 10px 5px;
    color: #777474;
    ...
    color: #777474;
    font-family: inherit;
    font-size: 18px;">Promotional Bulk SMS Provider Ahmedabad
</th>
                                            <th style="text-align: center;
    padding: 10px 5px;
    color: #777474;
